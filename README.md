...
&nbsp;
<img src="https://img.shields.io/github/followers/GOKUL-S-2006?style=for-the-badge&color=f5c518&labelColor=0d0d0d&logo=github&label=FOLLOWERS"/>
...
```yaml
alias       : Gokul S  (a.k.a The Dark Coder)
base        : VIT, India
education   : B.Sc Computer Science | CGPA 8.76
weapons     : Java, Node.js, C++, Spring Boot
arsenal     : DSA, REST APIs, MongoDB, Docker
mission     : Scalable Systems & Backend Domination
currently   : Learning Spring Boot & System Programming
...
## ⚡ Tech Arsenal — The Batcave Toolbox
...
### 🔧 Tools & Platforms
<img src="https://skillicons.dev/icons?i=docker,git,github,linux,kali,vscode,postman" />

</div>

---

## 🏆 Hall of Victories — The Trophy Room
...
## 🚀 Featured Projects — Gotham's Most Wanted
...
- 📡 Real-time issue tracking APIs

`React Native` `Expo` `Node.js` `Express.js` `MongoDB`

[![Repo](https://img.shields.io/badge/View%20Repo-f5c518?style=flat-square&logo=github&logoColor=black)](https://github.com/GOKUL-S-2006)
...
`HTML` `JavaScript` `Tailwind CSS` `REST APIs`
...
Currently cooking something sinister.

Stay tuned, Gotham.

[![GitHub](https://img.shields.io/badge/Follow%20for%20Updates-f5c518?style=flat-square&logo=github&logoColor=black)](https://github.com/GOKUL-S-2006)
...
## 📈 Training — The Batcave Progress Logs
...
&nbsp;
<a href="https://x.com/GOKULS582270">
